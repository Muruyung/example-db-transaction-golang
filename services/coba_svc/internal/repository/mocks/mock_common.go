...
// Source: /home/robi/ngoding/pribadi/example-db-transaction-golang/services/coba_svc/domain/repository/common.go
...
func (m *MockSqlTx) BeginTx(ctx context.Context, operation func(context.Context, *repository.Wrapper) error) error {
	m.ctrl.T.Helper()
